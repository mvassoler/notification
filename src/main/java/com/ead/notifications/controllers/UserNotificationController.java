package com.ead.notifications.controllers;

import com.ead.notifications.dtos.NotificationDto;
...
public class UserNotificationController {
    ...
    public ResponseEntity<Page<NotificationModel>> getAllNotificationsByUser(
        ...
        return ResponseEntity.status(HttpStatus.OK).body(this.notificationService.findAllNotificationsByYser(userId, pageable));
    }
